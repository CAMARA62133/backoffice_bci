...
!function (n) {
  ...
  function Qt(n) {
    ...
    var e, a, r, o, i, l = n.oScroll, s = l.sX, u = l.sXInner, c = l.sY, l = l.iBarWidth, f = P(n.nScrollHead),
      ...
      m = g.style, S = P(n.nScrollFoot).children("div"), v = S.children("table"), y = P(n.nTHead), D = P(n.nTable),
  ...
  function xe(t, e) {
    ...
    if (n.length && t.length) {
      ...
      if (a._details) {
        ...
        var s = n[0], r = new B(s), a = ".dt.DT_details", e = "draw" + a, t = "column-sizing" + a, a = "destroy" + a,
          u = s.aoData;
