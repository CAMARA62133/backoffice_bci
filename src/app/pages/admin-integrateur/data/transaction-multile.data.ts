...
export const TRANSACTIONS_MULTIPLES: TransactionMultiple[] = [
  // TRANSACTION 1 - JANVIER (En attente de validation)
  {
    id: 1,
    reference: 'TRX-SALAIRE-2026-01',
  ...
  // TRANSACTION 3 - MARS (En attente de validation)
  {
    id: 3,
    reference: 'TRX-SALAIRE-2026-03',
    statutDemande: 'En attente validation',
    typeTransaction: 'Salaire',
    date: '2026-03-31',
    lieu: 'Conakry',
  ...
  // TRANSACTION 5 - MAI (En attente de validation)
  {
    id: 5,
    reference: 'TRX-SALAIRE-2026-05',
    statutDemande: 'En attente validation',
    typeTransaction: 'Salaire',
    date: '2026-05-31',
    lieu: 'Conakry',
  ...
  // TRANSACTION 8 - AOUT (En attente de validation)
  {
    id: 8,
    reference: 'TRX-SALAIRE-2026-08',
    statutDemande: 'En attente validation',
    typeTransaction: 'Salaire',
    date: '2026-08-31',
    lieu: 'Conakry',
  ...
  // TRANSACTION 10 - OCTOBRE (En attente de validation)
  {
    id: 10,
    reference: 'TRX-SALAIRE-2026-10',
    statutDemande: 'En attente validation',
    typeTransaction: 'Salaire',
    date: '2026-10-31',
    lieu: 'Conakry',
