        ...
        counters.forEach(function (counter) {
            if (counter) {
                ...
                if (!isNaN(target)) {
                    ...
                    console.error("L'attribut 'data-target' est manquant ou invalide pour cet élément.");
                }
            }
        });
    }
        ...
        counters.forEach(function (counter) {
            if (counter) {
                ...
                function updateCount() {
                    if (count < target) {
                        count += increment;
                        counter.innerText = Math.ceil(count).toLocaleString('fr-GN', {
                            style: 'currency',
                            currency: 'GNF',
                        ...
                        counter.innerText = target.toLocaleString('fr-GN', {
                            style: 'currency',
                            currency: 'GNF',
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0
